...
dataset_gerado = '/home/balboni/funcoes/gb_score_Grad-model/dataset_gb_score.csv'
...
path_saved_model = "/home/balboni/funcoes/gb_score/gradient_model.joblib"
...
resultado.to_csv('predicao_gb_score_best-model.txt',sep=';',index=False)