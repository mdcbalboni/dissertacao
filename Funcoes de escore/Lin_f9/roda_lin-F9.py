...
caminho_base_de_dados = '/home/balboni/dados/v2020-other-PL/'
...
saida = open(caminho_saida+'lin-f9_predicao.txt','w')
saida.write('pdb;score_vina\n')
for dado in lista_pdb:
	try:
		caminho_proteina = str(caminho_base_de_dados) + dado+'/'
		output = subprocess.check_output('./smina.static -r ' + caminho_proteina+dado+'_protein.pdbqt -l ' + caminho_proteina+dado+'_ligand.pdbqt  --local_only --scoring Lin_F9', shell=True)
